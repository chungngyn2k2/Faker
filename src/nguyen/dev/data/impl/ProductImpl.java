	...
	public Product find(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                return new Product(id, name, description, thumbnail, price, quantity, category_id, created_at);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
	...
	public List<Product> findAll() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int category_id = rs.getInt("category_id");
                Timestamp created_at = rs.getTimestamp("created_at");
                prodList.add(new Product(id, name, description, thumbnail, price, quantity, category_id, created_at));
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
